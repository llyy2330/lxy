...
/**
 * @ClassName: IdWorker
 * @Description: PHP唯一ID生成扩展 ukey http://www.oschina.net/p/ukey 使用Twitter的
 *               Snowflake算法, 有兴趣可以了解一下这个算法:
 *               https://github.com/twitter/snowflake php.ini的配置项:
 * @author: lixiaoyong
 * @date:2013年11月7日 下午2:24:34
 */
